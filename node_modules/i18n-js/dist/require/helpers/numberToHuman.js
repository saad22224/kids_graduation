...
const parseBigNumber_1 = require("./parseBigNumber");
const DECIMAL_UNITS = {
    "0": "unit",
    "1": "ten",
    "2": "hundred",
...
function numberToHuman(i18n, input, options) {
    ...
    let formattedNumber = (0, roundNumber_1.roundNumber)((0, parseBigNumber_1.parseBigNumber)(input, options.raise), roundOptions);
